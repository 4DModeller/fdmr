...
To load data into the mesh builder we need to make sure it's in the correct format. We require latitude and longitude data
for each area in the spatial data. This can be in the form of a `SpatialPolygonsDataFrame` or a `SpatialPointsDataFrame`.
