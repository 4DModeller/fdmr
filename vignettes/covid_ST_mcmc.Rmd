...
This tutorial requires the [`CARBayesST`](https://cran.r-project.org/web/packages/CARBayesST/index.html) package. Please install it before continuing.
...
mcmc.mean.rate <- dplyr::group_by(mergedat, MSOA11CD) %>% dplyr::summarize(
...
INLA.mean.rate <- dplyr::group_by(mergedat, MSOA11CD) %>% dplyr::summarize(
