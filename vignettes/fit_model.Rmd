---
title: "Using the fit_model function to quickly build models"
output: 
...
The `fit_model` function is built to automatically build an inlabru model that has data constrained latent processes as well as fixed effects on an automatically generated mesh.

It will then return a fitted model `bru` object for use with the `fdmr::model_viewer` Shiny app or your own custom analysis.
