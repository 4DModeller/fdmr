...
- `sp_data` - the spatial data covering areas across the city of Bristol
- `covid19_data` - the COVID-19 data we want to model
- `mesh` - the mesh we created above

data we want to use, the measurement data 
