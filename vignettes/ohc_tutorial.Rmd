...
```{r sterrPlots, error = FALSE, fig.id=TRUE, fig.cap="Resampled standard deviation of mean field for L1 in 2005: (left) March, (right) October", fig.align='center', fig.width=8, fig.height=4}
