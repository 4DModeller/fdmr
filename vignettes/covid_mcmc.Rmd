...
This tutorial makes use of the [CARBayes package](https://cran.r-project.org/web/packages/CARBayes/index.html) which is not a dependency of 4DModeller, to follow through the tutorial you will need to install it.
