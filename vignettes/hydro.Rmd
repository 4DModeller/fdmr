...
We can have a look at the spatial data and the mesh using the `plot_interactive_map` Shiny app.
```{r}
max_edge = c(xres * 1, xres * 100)
cutoff = 75
sr <- "+proj=utm +zone=32"

fdmr::mesh_builder(spatial_data=xy, max_edge = max_edge, cutoff = 65, crs = sr)
```
...
Now it's time to see its output
