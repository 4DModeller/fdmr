...
```{r}
pred_field <- create_prediction_field(mesh, plot_type = "predicted_mean_fields", data_type = "gaussian", parsed_output$mean_post, parsed_output$fixed_mean)
pred_field
```
...
```{r eval=FALSE}
fdmr::model_viewer(model_output = inlabru_model2, mesh = mesh, measurement_data = inla_data, data_type = "Gaussian")
```
