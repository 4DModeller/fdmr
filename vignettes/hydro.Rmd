...
function with the names and positions.
...
between the pixel and each stream gauge, then use the minimum distance to choose the stream gauge. We first create a function that converts latlong to utm coordinate reference system
...
resolution <- res(era5_precip_cropped)
xres <- resolution[1]*2
yres <- resolution[2]*2
