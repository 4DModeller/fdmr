...
inlabru_model <- bru(formula, data = COVID19dat,
                   family = "poisson",
...
The infection rate predictions from the model can be computed using the following codes, and are saved in a data frame called "predictions". Note that this cell will only run if the model above has been run. Otherwise please run the cell below which loads in the saved predictions from a previous model run.
